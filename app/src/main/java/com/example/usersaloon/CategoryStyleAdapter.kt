...
class CategoryStyleAdapter (private val resultList: MutableList<StyleItem>)
    : RecyclerView.Adapter<CategoryStyleAdapter.CategoryStyleViewHolder>() {

    inner class CategoryStyleViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CategoryStyleViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.style_layout,
            parent, false)
        return CategoryStyleViewHolder(itemView)
    }

    override fun onBindViewHolder(holder: CategoryStyleViewHolder, position: Int) {
